...
check_password_extauth(do,User, Server, Password) ->
	true.
%% 	?INFO_MSG("##########################~p AUTH_Server=~p~nUser=~pPWD~p~n",[check_password_extauth,Server,User, Password]),
...
%% 	 PostBody = {obj,[{"service",Service},{"method",Method},{"channel",Channel},{"token",Password},{"params",{obj,[{"username",User},{"domain",Server}]}} ]},
%% 	?INFO_MSG("body=~p", [PostBody]),
